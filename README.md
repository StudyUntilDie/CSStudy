...
- 참고 강의: [CS지식의 정석](https://www.inflearn.com/course/%EA%B0%9C%EB%B0%9C%EC%9E%90-%EB%A9%B4%EC%A0%91-cs-%ED%8A%B9%EA%B0%95) - 큰돌   
  ...
  [컴퓨터네트워크](http://www.kocw.net/home/cview.do?cid=a042a065f8072d8a) - 김철기  
...
| 4 | 22/07/26 | 진호 | 면접을 위한 CS 전공지식 노트 |CPU 스케줄링 알고리즘(비선점형, 선점형) / 캐시, 캐시히트, 캐시미스와 캐시 사례| `완료`👍 |
|   |          | 윤정 | 면접을 위한 CS 전공지식 노트 |메모리할당 : 고정분할과 가변분할 (연속할당), 메모리할당 : 페이징, 세그멘테이션, 페이지드 세그멘테이션 (불연속할당)| `완료`👍|
|   |          | 건영 | 면접을 위한 CS 전공지식 노트 |PCB와 컨텍스트 스위칭 / 멀티프로세싱과 멀티스레딩, 그리고 IPC| `완료`👍 |
|   |          | 인혁 | 면접을 위한 CS 전공지식 노트 |공유자원과 임계 영역, 그리고 경쟁상태(race condition) / 세마포어, 뮤텍스, 모니터의 차이 그리고 교착상태(deadlock)| `완료`👍 |
|   |          | 경희 | 면접을 위한 CS 전공지식 노트 |프로그램과 프로세스 그리고 스레드의 차이 / 프로세스의 메모리 구조| `완료`👍 |
| 5 | 22/08/02 | 진호 | 컴퓨터네트워크 | 컴퓨터네트워크 기본 1 | `완료`👍 |
|   |          | 윤정 | 컴퓨터네트워크 | 컴퓨터네트워크 기본 1 | `완료`👍 |
|   |          | 건영 | 컴퓨터네트워크 | 컴퓨터네트워크 기본 1 | `완료`👍 |
|   |          | 인혁 | 컴퓨터네트워크 | 컴퓨터네트워크 기본 1 | `완료`👍 |
|   |          | 경희 | 컴퓨터네트워크 | 컴퓨터네트워크 기본 1 | `완료`👍 |  
| 6 | 22/08/09 | 진호 | 컴퓨터네트워크 | 컴퓨터네트워크 기본 2, 3 | `완료`👍 |
|   |          | 윤정 | 컴퓨터네트워크 | 컴퓨터네트워크 기본 2, 3 | `완료`👍 |
|   |          | 건영 | 컴퓨터네트워크 | 컴퓨터네트워크 기본 2, 3 | `완료`👍 |
|   |          | 인혁 | 컴퓨터네트워크 | 컴퓨터네트워크 기본 2, 3 | `완료`👍 |
|   |          | 경희 | 컴퓨터네트워크 | 컴퓨터네트워크 기본 2, 3 | `완료`👍 |  
| 7 | 22/08/16 | 진호, 윤정, 건영, 인혁, 경희 | 컴퓨터네트워크 | 컴퓨터네트워크 기본 4, 5 | `완료`👍 |
| 8 | 22/08/23 | 진호, 윤정, 건영, 인혁, 경희 | 컴퓨터네트워크 | 4강, 5-1강 | `진행중`🏃 |

...
| 5 | 22/08/02 | 진호 | 컴퓨터네트워크 | 컴퓨터네트워크 기본1 | `완료`👍 |
|   |          | 윤정 | 컴퓨터네트워크 | 컴퓨터네트워크 기본1 | `완료`👍 |
|   |          | 건영 | 컴퓨터네트워크 | 컴퓨터네트워크 기본1 | `완료`👍 |
|   |          | 인혁 | 컴퓨터네트워크 | 컴퓨터네트워크 기본1 | `완료`👍 |
|   |          | 경희 | 컴퓨터네트워크 | 컴퓨터네트워크 기본1 | `완료`👍 |  
| 6 | 22/08/09 | 진호 | 컴퓨터네트워크 | 컴퓨터네트워크 기본2 | `진행중`🏃 |
|   |          | 윤정 | 컴퓨터네트워크 | 컴퓨터네트워크 기본2 | `진행중`🏃 |
|   |          | 건영 | 컴퓨터네트워크 | 컴퓨터네트워크 기본2 | `진행중`🏃 |
|   |          | 인혁 | 컴퓨터네트워크 | 컴퓨터네트워크 기본2 | `진행중`🏃 |
|   |          | 경희 | 컴퓨터네트워크 | 컴퓨터네트워크 기본2 | `진행중`🏃 |  
